...
2. Clone the repo
```sh
git clone https://github.com/ShashanRasindu/Mdern-POS-JPA-Maven-Spring Data Access
```
...
Project Link: [https://github.com/ShashanRasindu/Mdern-POS-JPA-Maven-Spring Data Access](https://github.com/ShashanRasindu/JPA---POS)
